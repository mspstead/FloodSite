...
def timeline(request):
    ...
    start_date = ordered_photo_list[0].date_taken #make start_date for flood events equal to first flood photo date
    ...
    for x in range(0, len(ordered_photo_list)): #cycle through the list
        ...
        if difference < 7: #check the difference is less than 7 days
